...
async def generate_synthetic_students(
    ...
    host: str = Query("users_db", description="PostgreSQL host"),
    port: int = Query(5432, description="PostgreSQL port"),
    dbname: str = Query("onboarding", description="PostgreSQL database name"),
    user: str = Query("postgres", description="PostgreSQL user"),
    password: str = Query("rootcode", description="PostgreSQL password"),
